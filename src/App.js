...
import ReactRouterDemo from './Components/Router/reactRouter';
import StrictModeDemo from './Components/StrictMode/strictMode';
import ConcurrentModeDemo from './Components/ConcurrentMode/useTransition';
import CustomHooksDemo from './Components/CustomHooks/customHooks';
import CompoundComponentsDemo from './Components/CompoundComponents/compoundComponents';
        ...
        <div className="App">
          <Routes>
            ...
            <Route element={<SidebarLayout />}>
              ...
              <Route path='/my-router' element = {<ReactRouterDemo />} />
              ...
              <Route path='/my-CustomHooks' element={<CustomHooksDemo />} />
              <Route path='/my-useTransition' element={<ConcurrentModeDemo />} />
              ...
              <Route path='/my-StrictMode' element={<StrictModeDemo />} />
              <Route path='/my-RenderProps' element={<RenderProps />} />
              <Route path='/my-CompoundComponents' element={<CompoundComponentsDemo />} />
